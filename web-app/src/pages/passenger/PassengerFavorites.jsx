...
import { FaStar, FaMapMarkerAlt, FaPlus, FaTrash, FaHome, FaBriefcase, FaUniversity } from 'react-icons/fa';
        ...
        <div className="favorites-grid">
          {favorites.map(fav => (
            <Card key={fav._id} className="favorite-card" hover>
              ...
              <button className="favorite-delete" onClick={() => handleDelete(fav._id)}>
                <FaTrash size={14} />
              </button>
            </Card>
          ))}
